...
"""
function rel_residue(recomposed::AbstractArray{T, N}, tensor::AbstractArray{T, N}) where {T <: Number, N}
	nans = .!isnan.(tensor)
...
"""
rel_residue(decomp::TensorDecomposition{T, N}, tensor::AbstractArray{T, N}) where {T <: Number, N} =
...
_set_rel_residue(decomp::TensorDecomposition{T,N}, tensor::AbstractArray{T,N}) where {T <: Number, N} =
